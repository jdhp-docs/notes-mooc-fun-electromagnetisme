...
TODO_DOCUMENT_DATE="November 15, 2016"
TODO_INSTITUTE=""
TODO_DOCUMENT_SUBJECT="Electromagnetisme"
TODO_DOCUMENT_KEYWORDS="physique,electromagnetisme,mooc,fun"

TODO_DOCUMENT_TITLE="Introduction à l'électromagnétisme"
TODO_DOCUMENT_SUBTITLE="Notes personnelles du MOOC FUN"
TODO_DOCUMENT_FILE_BASE_NAME="notes_mooc_fun_electromagnetisme"

TODO_DOCUMENT_GITHUB_ACCOUNT="jdhp-docs"
TODO_DOCUMENT_GITHUB_REPOSITORY_NAME="notes-mooc-fun-electromagnetisme"
